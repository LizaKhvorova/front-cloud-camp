...
export const composeHooks = (hooks) => (Component) => {
    ...
    return (properties) => {
        ...
        const hooksProperties = Object.entries(hooksObject).reduce((accumulator, [hookKey, hook]) => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
            // @ts-ignore
            let hookValue = hook();
        ...
        return React.createElement(Component, Object.assign({}, hooksProperties, properties));
    };
};
